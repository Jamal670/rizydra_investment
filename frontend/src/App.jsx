  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/insights" element={<ProtectedRoute userOnly><Insights /></ProtectedRoute>} />
        ...
        <Route path="/admin-setting" element={<ProtectedRoute adminOnly><AdminSetting /></ProtectedRoute>} />
        {/* Fallback */}
