...
const AdminWithdraw = () => {
    ...
    useEffect(() => {
        api.get("/admin/adminGetAllUsersWithdraw")
            .then(res => {
    ...
    const filteredWithdrawals = withdrawals.filter(row => {
        ...
        const statusMatch =
            ...
            (filterStatus === "Confirmed" && row.status === "Comfirmed");
    ...
    const { paginatedRows, totalRows, totalPages } = useSearchPagination(filteredWithdrawals, "", currentPage);
    ...
    const handleConfirmed = async () => {
        ...
        try {
            const res = await api.post("/admin/adminHandleWithdrawConfirmed", { _id: selectedRow._id });
            setActionMessage(res.data.message || "Withdraw confirmed successfully");
            setShowModal(false);
            setProcessingAction("");
            // Refresh withdrawals
            const updated = await api.get("/admin/adminGetAllUsersWithdraw");
            setWithdrawals(updated.data.withdrawals || []);
            setStatusBreakdown(updated.data.statusBreakdown || []);
        } catch (err) {
            setActionMessage("Failed to confirm withdraw");
            setProcessingAction("");
        }
    };
    ...
    const handleDeclineSubmit = async () => {
        ...
        try {
            await api.post("/admin/adminHandleWithdrawDeclined", {
                _id: selectedRow._id,
                comment: declineComment
            });
            setActionMessage("Withdraw declined successfully");
            ...
            setActionMessage("Failed to decline withdraw");
            setProcessingAction("");
            setShowDeclineModal(false);
            setShowModal(false);
        }
                ...
                <div className="row">
                    ...
                    <div className="col-md-3 col-lg-2 d-none d-md-block bg-white sidebar border-end vh-100 sticky-top" style={{ zIndex: 1010, top: "56px" }}>
                        <div className="p-3">
                            ...
                            <ul className="nav flex-column">
                                ...
                                <li className="nav-item mb-2">
                                    <a className="nav-link active bg-primary text-white rounded" href="/admin-withdraw">
                    ...
                    <main className="col-md-9 col-lg-10 px-md-4 py-3">
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-4">
                            <h2 className="h4 fw-bold text-dark">Withdraw Overview</h2>
                        </div>
                        ...
                        <div className="card border-0 shadow-sm">
                            <div className="card-header bg-white border-0 py-3">
                                <div className="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h5 className="mb-0 fw-bold text-dark">Withdraw Management</h5>
                                        <p className="text-muted mb-0">Manage all withdrawals from this panel</p>
                                    </div>
            ...
            >
                ...
                <div className="offcanvas-body">
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item mb-2">
                            <a className="nav-link text-dark" href="/admin-deposit">
                                <i className="bi bi-chat-left-text me-2"></i> Deposit
                            </a>
                        </li>
                        <li className="nav-item mb-2">
                            <a
                            ...
                            >
                                <i className="bi bi-house me-2"></i> Withdraw
                            </a>
                        </li>
                        <li className="nav-item mb-2">
                            <a className="nav-link text-dark" href="/admin-contact">
